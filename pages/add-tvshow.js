...
const handlePreview = async () => {
  ...
  try {
    ...
    if (res.ok) {
      ...
      setError('TV Show tidak ditemukan. Pastikan TMDB ID valid.');
      setPreview(null);
    }
  } catch (error) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        setError(errorData.message || 'Gagal menambahkan TV Show');
      }
    } catch (error) {
      setError('Terjadi kesalahan saat menambahkan TV Show');
    }
    setLoading(false);
  };
        ...
        <div style={{ maxWidth: '800px', margin: '0 auto' }}>
          <div className="slide-up" style={{ textAlign: 'center', marginBottom: '50px' }}>
            ...
            <p style={{ 
              ...
              Masukkan TMDB ID untuk menambahkan TV Show ke koleksi Anda
            </p>
          </div>
          <div className="glass-effect" style={{
            ...
            <form onSubmit={handleSubmit} style={{ marginBottom: '24px' }}>
              <div style={{ marginBottom: '20px' }}>
                ...
                <div style={{ display: 'flex', gap: '12px' }}>
                  <input
                    ...
                    placeholder="📺 Contoh: 1399 (Game of Thrones)"
                    ...
                    onFocus={(e) => {
                      e.target.style.borderColor = 'rgba(0, 234, 255, 0.5)';
              ...
              <div style={{ display: 'flex', gap: '12px', justifyContent: 'center' }}>
                ...
                >
                  {loading ? '⏳ Memproses...' : preview ? '✨ Tambahkan TV Show' : '🔍 Cari TV Show'}
                </button>
              </div>
            </form>
          </div>
              ...
              <div style={{ display: 'flex', gap: '24px', alignItems: 'flex-start' }}>
                ...
                <div style={{ flex: '1' }}>
                  ...
                  <p style={{ 
                    ...
                    📅 {preview.first_air_date ? new Date(preview.first_air_date).getFullYear() : '-'}
                  </p>
                  <p style={{ 
                    color: 'rgba(255,255,255,0.8)', 
                    marginBottom: '16px',
